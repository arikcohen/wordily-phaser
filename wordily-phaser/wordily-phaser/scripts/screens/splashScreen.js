...
(function (Wordily) {
    var SplashScreen = /** @class */ (function (_super) {
        ...
        SplashScreen.prototype.preload = function () {
            ...
            this.cardW = new Wordily.Card(-1, "W", true, 0, constSeperation * 3.5, -400, this.cardTitleGroup);
            this.cardO = new Wordily.Card(-1, "O", true, 0, constSeperation * 3.5, -400, this.cardTitleGroup);
            this.cardR = new Wordily.Card(-1, "R", true, 0, constSeperation * 3.5, -400, this.cardTitleGroup);
            this.cardD = new Wordily.Card(-1, "D", true, 0, constSeperation * 3.5, -400, this.cardTitleGroup);
            this.cardI = new Wordily.Card(-1, "I", true, 0, constSeperation * 3.5, -400, this.cardTitleGroup);
            this.cardJoker = new Wordily.Card(-1, "JOKER", true, 0, constSeperation * 3.5, -400, this.cardTitleGroup);
            this.cardJoker2 = new Wordily.Card(-1, "JOKER", true, 0, constSeperation * 3.5, -400, this.cardTitleGroup);
        ...
        SplashScreen.prototype.create = function () {
            ...
            if (showSplash) {
                ...
                var tweenJokerAway = this.add.tween(this.cardJoker).to({ y: this.world.height }, duration * 2, Phaser.Easing.Linear.None, true, delay * 8);
                var tweenJoker2Away = this.add.tween(this.cardJoker2).to({ y: this.world.height }, duration * 2, Phaser.Easing.Linear.None, true, delay * 8);
                var tweenLY = this.add.tween(this.cardLY).to({ x: constSeperation * 5, y: 0 }, duration * 2, Phaser.Easing.Linear.None, true, delay * 9);
                var tweenCardsTop = this.add.tween(this.cardTitleGroup).to({ x: this.world.centerX - 3 * constSeperation, y: 20 }, duration * 2, Phaser.Easing.Linear.None, true, delay * 10);
