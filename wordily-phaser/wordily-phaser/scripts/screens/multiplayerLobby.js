...
var Wordily;
(function (Wordily) {
    var MultiplayerLobby = /** @class */ (function (_super) {
        __extends(MultiplayerLobby, _super);
        function MultiplayerLobby() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        MultiplayerLobby.prototype.create = function () {
        ...
        MultiplayerLobby.prototype.startSolitaireGame = function () {
            this.game.state.start('Solitaire', true, false);
        };
        MultiplayerLobby.prototype.startMultiplayerGame = function () {
            alert('no muliplayer yet');
        };
        return MultiplayerLobby;
    }(Phaser.State));
    Wordily.MultiplayerLobby = MultiplayerLobby;
})(Wordily || (Wordily = {}));
