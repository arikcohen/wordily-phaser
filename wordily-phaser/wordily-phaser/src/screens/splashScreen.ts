module Wordily {
    ...
    export class SplashScreen extends Phaser.State {
        ...
        preload() {
            ...
            this.cardW = new Card(-1, "W", true,0 , constSeperation * 3.5, -400, this.cardTitleGroup);
            this.cardO = new Card(-1, "O", true, 0, constSeperation * 3.5, -400, this.cardTitleGroup);
            this.cardR = new Card(-1, "R", true, 0, constSeperation * 3.5, -400, this.cardTitleGroup);            
            this.cardD = new Card(-1, "D", true, 0, constSeperation * 3.5, -400, this.cardTitleGroup);
            this.cardI = new Card(-1, "I", true, 0, constSeperation * 3.5, -400, this.cardTitleGroup);
            this.cardJoker = new Card(-1, "JOKER", true, 0, constSeperation * 3.5, -400, this.cardTitleGroup);            
            this.cardJoker2 = new Card(-1, "JOKER", true, 0, constSeperation * 3.5, -400, this.cardTitleGroup);            
