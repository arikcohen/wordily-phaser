...
declare module PlayFabClientModule {
    export interface IPlayFabClient {
         ...
         */
        LoginWithFacebookInstantGamesID(request: PlayFabClientModels.LoginWithCustomIDRequest, callback: PlayFabModule.ApiCallback<PlayFabClientModels.LoginResult>, customData?: any, extraHeaders?: { [key: string]: string }): void;
