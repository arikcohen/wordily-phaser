...
(function (Wordily) {
    ...
    var Stack = /** @class */ (function (_super) {
            ...
            for (var c = 0; c < this.length; c++) {
                ...
                switch (this.orientation) {
                    ...
                    case StackOrientation.HorizontalDisplay: {
                        x = c * (this.dropSlot.width + Stack.offsetHorizonatalDisplay);
                        y = 0;
                        break;
                    }
        ...
        Stack.offsetHorizonatalDisplay = 50;
...
(function (Wordily) {
    var MainMenu = /** @class */ (function (_super) {
        ...
        MainMenu.prototype.create = function () {
            ...
            this.cardW = new Wordily.Card("W", null, wordilyStartX, wordilyStarty, this.cardTitleGroup, this);
            this.cardO = new Wordily.Card("O", null, wordilyStartX + constSeperation * 1, wordilyStarty, this.cardTitleGroup, this);
            this.cardR = new Wordily.Card("R", null, wordilyStartX + constSeperation * 2, wordilyStarty, this.cardTitleGroup, this);
            this.cardD = new Wordily.Card("D", null, wordilyStartX + constSeperation * 3, wordilyStarty, this.cardTitleGroup, this);
            this.cardI = new Wordily.Card("I", null, wordilyStartX + constSeperation * 4, wordilyStarty, this.cardTitleGroup, this);
            this.cardLY = new Wordily.Card("LY", null, wordilyStartX + constSeperation * 5, wordilyStarty, this.cardTitleGroup, this);
    ...
    var SolitaireGame = /** @class */ (function (_super) {
        ...
        SolitaireGame.prototype.create = function () {
            ...
            for (var iStack = 0; iStack < this.numStacks; iStack++) {
                var s = new Wordily.Stack(this, "stack " + iStack, Wordily.StackOrientation.VerticalStack, (Wordily.Game.DefaultCardWidth + SolitaireGame.stackOffsetHorizontal) * iStack + SolitaireGame.stackOffsetHorizontal, this.world.bottom - Wordily.Game.DefaultCardHeight - (SolitaireGame.stackOffsetVertical));
                this.stacks.push(s);
            }
